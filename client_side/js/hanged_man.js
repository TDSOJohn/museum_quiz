$("body").append("<div class=\"container-fluid bg-cover\" id=\"sfondo\" style=\"background-image: url('background.png'); background-repeat: no-repeat;background-position: center; height: 100%; width: 100%; background-size: cover;\"><div class=\"row\" style=\"height: 15vh\"><div class=\"col-sm\"><h1 style=\"text-align: center; font-size:3vh;\"><b><i>RISPOSTA:</i></b></h1></div></div>")
...
$("#risposta").append("<p id=\"frase\">La risposta è:</p><div id=\"interazione\"><p id=\"suggerimento\"></p><input type=\"text\" id=\"insert\" onfocus=\"this.value=''\" value=\"inserisci la tua risposta\"></input><button onclick=\"controlla()\">Invia la risposta</button></div>")
