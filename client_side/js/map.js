...
$(function () {
    ...
    $('.btn1').click(function () {
        ...
        window.location.href = `gioco.html?id_missione=0?&id=${myJsonID}`;
    });
    $('.btn2').click(function () {
        localStorage.removeItem('btn2');
        ...
        window.location.href = `gioco.html?id_missione=1?&id=${myJsonID}`;
    });
    $('.btn3').click(function () {
        localStorage.removeItem('btn3');
        ...
        window.location.href = `gioco.html?id_missione=2?&id=${myJsonID}`;
    });
    $('.btn4').click(function () {
        localStorage.removeItem('btn4');
        ...
        window.location.href = `gioco.html?id_missione=3?&id=${myJsonID}`;
    });
    $('.btn5').click(function () {
        localStorage.removeItem('btn5');
        ...
        window.location.href = `gioco.html?id_missione=4?&id=${myJsonID}`;
    });
    $('.btn6').click(function () {
        localStorage.removeItem('btn6');
        ...
        window.location.href = `gioco.html?id_missione=5?&id=${myJsonID}`;
    });
    $('.btn7').click(function () {
        localStorage.removeItem('btn7');
        ...
        window.location.href = `gioco.html?id_missione=6?&id=${myJsonID}`;
    });
    $('.btn8').click(function () {
        localStorage.removeItem('btn8');
        ...
        window.location.href = `gioco.html?id_missione=7?&id=${myJsonID}`;
    });
    $('.btn9').click(function () {
        localStorage.removeItem('btn9');
        ...
        window.location.href = `gioco.html?id_missione=8?&id=${myJsonID}`;
    });
